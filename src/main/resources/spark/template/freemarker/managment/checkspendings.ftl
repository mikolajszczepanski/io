...
<table class="table table-striped table-hover ">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="#" type="button" onclick="deleteButton('${frequency}','${transaction.getAmount()}','${transaction.getCategory().getName()}','${transaction.getStringDate()}','${transaction.getId()}')">usuń</a></td>
		</tr>
		</#list>
	</tbody>
</table>
